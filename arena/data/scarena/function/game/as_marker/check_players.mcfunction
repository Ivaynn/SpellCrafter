...
execute unless score $game.players scarena.tmp matches 1.. run return run function scarena:game/as_marker/end_game
...
execute unless score $game.players.alive scarena.tmp matches 1.. run scoreboard players set @s scarena.game.timer 60
