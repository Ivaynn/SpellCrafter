...
data merge entity @s {DeathLootTable:"spellcrafter:egg/dummy",PersistenceRequired:1b,NoAI:1b,Silent:1b,Health:1024.0f,DuplicationCooldown:2147483647,AbsorptionAmount:2048f,attributes:[{id:"minecraft:max_health",base:1024.0},{id:"minecraft:max_absorption",base:2048.0},{id:"minecraft:scale",base:2.0}]}
