...
loot replace entity @s inventory.11 loot spellcrafter:spells/anchor_explosion
...
loot replace entity @s inventory.14 loot spellcrafter:spells/summon_lightning
