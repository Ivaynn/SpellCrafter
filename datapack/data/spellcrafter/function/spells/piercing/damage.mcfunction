...
execute if score @s spellcrafter.blind matches 1.. positioned ~ ~-0.75 ~ as @e[distance=..1.5,type=!#spellcrafter:untargetable,predicate=!spellcrafter:match_id] unless score @s spellcrafter.damage matches 1.. store result score $tmp.damaged spellcrafter.tmp run function spellcrafter:damage/from_projectile
execute unless score @s spellcrafter.blind matches 1.. positioned ~ ~-0.75 ~ as @e[distance=..1.5,type=!#spellcrafter:untargetable] unless score @s spellcrafter.damage matches 1.. store result score $tmp.damaged spellcrafter.tmp run function spellcrafter:damage/from_projectile
