...
execute if score $damage spellcrafter.tmp matches 1.. positioned ~ ~-0.75 ~ as @e[distance=..1.5,limit=1,sort=nearest,type=!#spellcrafter:untargetable] run function spellcrafter:damage/from_projectile
