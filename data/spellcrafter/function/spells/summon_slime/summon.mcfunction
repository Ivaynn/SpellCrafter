...
# Summon entity
execute align xyz positioned ~.5 ~ ~.5 run summon minecraft:slime ~ ~ ~ {Tags:["spellcrafter.summon","spellcrafter.tmp"],Invulnerable:1b,DeathLootTable:"",PersistenceRequired:1b,Size:0,Health:1.0f,attributes:[{id:"minecraft:max_health",base:1.0f}]}
