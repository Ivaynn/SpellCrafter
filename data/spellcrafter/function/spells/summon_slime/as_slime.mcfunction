...
execute if score $spell.summon_slime spellcrafter.tmp matches 4 run data merge entity @s {Size:0,Health:20.0f,attributes:[{id:"minecraft:scale",base:6},{id:"minecraft:max_health",base:35}]}
execute if score $spell.summon_slime spellcrafter.tmp matches 5.. run data merge entity @s {Size:0,Health:30.0f,attributes:[{id:"minecraft:scale",base:9},{id:"minecraft:max_health",base:50}]}
