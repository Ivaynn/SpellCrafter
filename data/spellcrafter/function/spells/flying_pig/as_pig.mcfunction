...
# Update entity NBT
data merge entity @s {Invulnerable:1b,DeathLootTable:"",PersistenceRequired:1b,Saddle:1b,AbsorptionAmount:2048f,attributes:[{id:"minecraft:armor",base:30},{id:"minecraft:max_absorption",base:2048},{id:"minecraft:movement_speed",base:-100}]}
