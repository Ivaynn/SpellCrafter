...
execute if score $has_target spellcrafter.tmp matches 0 as @s[type=minecraft:armor_stand] unless score @s spellcrafter.cooldown matches 1.. if predicate spellcrafter:holding_wand run function spellcrafter:as_caster/use_wand
