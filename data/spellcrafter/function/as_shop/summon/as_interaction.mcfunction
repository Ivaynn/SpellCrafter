...
summon minecraft:text_display ~ ~ ~ {Tags:["spellcrafter.shop","spellcrafter.shop.tmp","spellcrafter.shop.text"],billboard:"vertical",alignment:"center",view_range:1.0f,text:'{"text":"1"}',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.6f,0f],scale:[1f,1f,1f]}}
