...
data merge entity @s {CustomName:{"text":"Target Dummy","color":"aqua"},CustomNameVisible:0b,PersistenceRequired:1b,NoAI:1b,Silent:1b,Health:1024.0f,DuplicationCooldown:2147483647}
