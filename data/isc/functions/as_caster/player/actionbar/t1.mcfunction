...
title @s actionbar ["",{"text":"◆ ","color":"aqua"},{"score":{"name":"@s","objective":"isc.mana"},"color":"aqua"},{"text":"   ⌚ ","color":"gray"},{"score":{"name":"$d0","objective":"isc.tmp"},"color":"gray"},{"text":".","color":"gray"},{"score":{"name":"$d1","objective":"isc.tmp"},"color":"gray"},{"score":{"name":"$d2","objective":"isc.tmp"},"color":"gray"}]
