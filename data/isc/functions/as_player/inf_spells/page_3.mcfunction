...
loot replace entity @s inventory.1 loot isc:spells/clone
loot replace entity @s inventory.2 loot isc:spells/multishot
loot replace entity @s inventory.3 loot isc:spells/ghost
...
loot replace entity @s inventory.20 loot isc:spells/hidden
