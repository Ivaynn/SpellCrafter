...
loot replace entity @s inventory.5 loot isc:spells/heal
loot replace entity @s inventory.6 loot isc:spells/explosion
loot replace entity @s inventory.7 loot isc:spells/summon_lightning

loot replace entity @s inventory.10 loot isc:spells/summon_vex
loot replace entity @s inventory.11 loot isc:spells/summon_bat
loot replace entity @s inventory.12 loot isc:spells/summon_slime
loot replace entity @s inventory.13 loot isc:spells/sheep
loot replace entity @s inventory.14 loot isc:spells/summon_pufferfish
loot replace entity @s inventory.15 loot isc:spells/summon_tnt
loot replace entity @s inventory.16 loot isc:spells/firework_rocket
