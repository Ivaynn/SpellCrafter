...
loot replace entity @s inventory.10 loot isc:wands/mod/shuffle
loot replace entity @s inventory.11 loot isc:wands/mod/multicast
loot replace entity @s inventory.12 loot isc:wands/mod/instant
loot replace entity @s inventory.13 loot isc:wands/mod/homing
loot replace entity @s inventory.14 loot isc:wands/mod/guide
loot replace entity @s inventory.15 loot isc:wands/mod/piercing
...
loot replace entity @s inventory.23 loot isc:wands/mod/spiral
loot replace entity @s inventory.24 loot isc:wands/mod/chaotic
loot replace entity @s inventory.25 loot isc:wands/mod/random_dir
