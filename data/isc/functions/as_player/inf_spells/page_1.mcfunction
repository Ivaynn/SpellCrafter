...
loot replace entity @s inventory.10 loot isc:wands/mod/multicast
loot replace entity @s inventory.11 loot isc:wands/mod/instant
loot replace entity @s inventory.12 loot isc:wands/mod/random_dir
