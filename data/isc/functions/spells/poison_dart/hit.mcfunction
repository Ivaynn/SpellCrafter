...
execute if score damage_caster isc.options matches 1 run effect give @e[distance=..3,limit=1,sort=nearest,type=!#isc:untargetable,tag=!isc.untargetable,tag=!isc.spectator] minecraft:poison 5 0 false
