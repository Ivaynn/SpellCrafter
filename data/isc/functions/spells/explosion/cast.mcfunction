...
execute positioned ~ ~-1 ~ as @e[distance=..5,type=!#isc:untargetable] run damage @s 16 minecraft:player_explosion by @e[limit=1,type=#isc:caster,tag=isc.caster,predicate=isc:match_id]
