...
execute if score damage_caster isc.options matches 1 run effect give @e[distance=..10,type=!#isc:untargetable,tag=!isc.untargetable,tag=!isc.spectator] minecraft:glowing 15 0 false
