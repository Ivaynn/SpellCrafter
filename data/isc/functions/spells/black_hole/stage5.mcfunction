...
execute at @e[distance=..3,type=!#isc:untargetable,tag=!isc.spectator,tag=!isc.untargetable] positioned ~ ~1 ~ facing entity @s feet positioned ~ ~-1 ~ as @e[distance=..0.001,type=!#isc:untargetable,tag=!isc.spectator,tag=!isc.untargetable] run tp @s ^ ^ ^.1
