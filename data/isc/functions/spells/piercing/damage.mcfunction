...
execute as @s[tag=!isc.spell.laser,tag=!isc.spell.black_hole,tag=!isc.spell.boomerang,tag=!isc.spell.arcane_shield,tag=!isc.spell.healing_circle] run scoreboard players operation $damage isc.tmp /= #2 isc.math
