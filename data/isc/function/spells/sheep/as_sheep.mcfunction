...
# Update entity NBT
data merge entity @s {Invulnerable:0b,DeathLootTable:"empty",PersistenceRequired:1b,attributes:[{id:"minecraft:generic.armor",base:100},{id:"minecraft:generic.knockback_resistance",base:1},{id:"minecraft:generic.movement_speed",base:0.5}]}
