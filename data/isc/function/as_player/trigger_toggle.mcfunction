...
# Chat message
tellraw @s[tag=isc.caster] ["",{"text":"> ","color":"dark_aqua","bold":true},{"text":"Spell casting enabled","color":"gray"}]
tellraw @s[tag=!isc.caster] ["",{"text":"> ","color":"red","bold":true},{"text":"Spell casting disabled","color":"gray"}]
