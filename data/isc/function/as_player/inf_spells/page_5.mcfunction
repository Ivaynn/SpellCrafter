...
loot replace entity @s inventory.10 loot isc:spells/explosion
loot replace entity @s inventory.11 loot isc:spells/large_explosion
loot replace entity @s inventory.12 loot isc:spells/firework_rocket
loot replace entity @s inventory.13 loot isc:spells/summon_tnt
loot replace entity @s inventory.14 loot isc:spells/summon_lightning
loot replace entity @s inventory.15 loot isc:spells/summon_fangs
loot replace entity @s inventory.16 loot isc:spells/wind_charge
...
loot replace entity @s inventory.25 loot isc:spells/flying_pig
