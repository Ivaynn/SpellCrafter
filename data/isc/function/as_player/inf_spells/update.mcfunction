...
clear @s minecraft:lava_bucket[minecraft:custom_data={isc:{gui:2}}]
clear @s minecraft:arrow[minecraft:custom_data={isc:{gui:3}}]


# Place buttons
item replace entity @s inventory.8 with minecraft:arrow[minecraft:item_name='{"text":"Previous Page"}',minecraft:custom_data={isc:{gui:1}}]
item replace entity @s inventory.17 with minecraft:lava_bucket[minecraft:item_name='{"text":"Trash"}',minecraft:custom_data={isc:{gui:2}}]
item replace entity @s inventory.26 with minecraft:arrow[minecraft:item_name='{"text":"Next Page"}',minecraft:custom_data={isc:{gui:3}}]
