...
loot replace entity @s inventory.0 loot isc:spells/random_dir
loot replace entity @s inventory.1 loot isc:spells/aim_assist
loot replace entity @s inventory.2 loot isc:spells/homing
loot replace entity @s inventory.3 loot isc:spells/warp
loot replace entity @s inventory.4 loot isc:spells/guide
loot replace entity @s inventory.5 loot isc:spells/follow
loot replace entity @s inventory.6 loot isc:spells/orbit
loot replace entity @s inventory.7 loot isc:spells/rainbow

loot replace entity @s inventory.9 loot isc:spells/chaotic
loot replace entity @s inventory.10 loot isc:spells/spiral
loot replace entity @s inventory.11 loot isc:spells/zigzag
loot replace entity @s inventory.12 loot isc:spells/wave
