...
loot replace entity @s inventory.6 loot isc:spells/follow
...
loot replace entity @s inventory.14 loot isc:spells/return
...
loot replace entity @s inventory.20 loot isc:spells/orbit
