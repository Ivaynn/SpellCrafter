...
# Buttons
# execute unless data entity @s Inventory[{Slot:27,id:"minecraft:lava_bucket",components:{"minecraft:custom_data":{isc:{gui:5}}}}] run say trash
...
execute unless data entity @s Inventory[{Slot:17b,id:"minecraft:arrow",components:{"minecraft:custom_data":{isc:{gui:2}}}}] unless score @s isc.inf_page matches 107.. run scoreboard players add @s isc.inf_page 1
...
execute unless data entity @s Inventory[{Slot:26b,id:"minecraft:spectral_arrow",components:{"minecraft:custom_data":{isc:{gui:4}}}}] run scoreboard players set @s isc.inf_page 107
# execute unless data entity @s Inventory[{Slot:35b,id:"minecraft:lava_bucket",components:{"minecraft:custom_data":{isc:{gui:6}}}}] run say trash
