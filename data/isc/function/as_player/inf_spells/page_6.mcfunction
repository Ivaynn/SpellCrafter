...
loot replace entity @s inventory.1 loot isc:spells/double_cast
loot replace entity @s inventory.2 loot isc:spells/triple_cast
loot replace entity @s inventory.3 loot isc:spells/multicast
