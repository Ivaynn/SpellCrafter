...
summon minecraft:text_display ~ ~ ~ {Tags:["isc.shop","isc.shop.tmp","isc.shop.text"],billboard:"vertical",alignment:"center",view_range:1.0f,text:'{"text":"123"}',transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0.6f,0f],scale:[1f,1f,1f]}}
